...
fastq-dump --gzip --split-files SRR5930498

# De novo metagenome assembly
# SPAdes - http://cab.spbu.ru/software/spades/
spades.py -1 SRR5930498_1.fastq.gz -2 SRR5930498_2.fastq.gz -o P10.SPAdes --meta

# Gene annotation and abundance quantification
perl ../../MetaPrism_gene.pl -p 8 P10.gene P10.SPAdes/scaffolds.fasta SRR5930498_1.fastq.gz,SRR5930498_2.fastq.gz
